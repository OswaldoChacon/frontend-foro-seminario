...
export class HorarioJuradoService {
  ...
  agregarHorario(num_control: string, fecha: Date, intervalo: any) {
    return this.http.post(`api/agregar_horario`, { num_control: num_control, fecha: fecha, posicion: intervalo.posicion, hora: intervalo.hora }).pipe(
      catchError((error) => {
  ...
  eliminarHorario(num_control: string, fecha: Date, intervalo: any) {
    return this.http.delete(`api/eliminar_horario/${num_control}`, {
  ...
  agregarHorarioAll(num_control: string, fecha: any) {
    return this.http.post(`api/agregar_horario_all`, { num_control: num_control, fecha: fecha }).pipe(
      catchError((error) => {
        fecha.checked = false;
        return throwError(error);
      })
  ...
  eliminarHorarioAll(num_control: string, fecha: any) {
    return this.http.delete(`api/eliminar_horario_all/${num_control}`, {
